...
goto end
:doneLib
set CLASSPATH=%MIBBLE_HOME%\lib\@NAME@-@VERSION@.jar;%MIBBLE_HOME%\lib\mibble-mibfiles-@VERSION@.jar;%MIBBLE_HOME%\lib\grammatica-bin-1.4.jar;%MIBBLE_HOME%\lib\snmp4_13.jar
